...
public struct Message {
  ...
  public var font: UIFont
    ...
    public init(title: String, textFont: UIFont = UIFont.systemFont(ofSize: 13), textColor: UIColor = UIColor.white, backgroundColor: UIColor = UIColor.lightGray, images: [UIImage]? = nil) {
    self.title = title
